...
namespace PDS.ViewYourFunding.Web.Areas.LoggedIn.Models
{
    ...
    /// </summary>
    public class LARecoupmentHistoryViewModel : LoggedInProviderBasePage
    {
        /// <summary>
        ...
        public override IList<BreadCrumbViewModel> BreadCrumbItems
        {
            get
            {
                var items = RecopementHistorySecondLevelBaseBreadCrumbItems(false);
                items.Add(LARecoupmentHistoryBreadcrumb(true, FundingStream.FundingStreamName.ToUIPathComponent(), OrganisationUkprn));
                return items;
            }
        }
        ...
        /// </summary>
        public override string BrowserTitle => LoggedInConstants.BrowserTitle_AllocationHistory;
        ...
        /// <summary>
        /// Gets or sets a list of key-value pairs mapping the funding period years (e.g. "2020", "2021") to the list of the local authority funding for that period.
        /// </summary>
        public List<KeyValuePair<(int yearFrom, int yearTo), List<LocalAuthorityFundingViewModel>>> FundingPeriodLocalAuthorityFundings { get; set; }
    }
}
