...
namespace PDS.ViewYourFunding.Web.Areas.LoggedIn.Models
{
    ...
    /// </summary>
    public class ProviderFundingBreakdownViewModel : LoggedInProviderBasePage
    {
        /// <summary>
        ...
        public string DocumentTitle =>
            string.Format(ViewYourFundingConstants.DocumentTitle_LAFundingBreakdown, OrganisationName, YearFrom, YearTo, FundingStream.FundingStreamCode);
