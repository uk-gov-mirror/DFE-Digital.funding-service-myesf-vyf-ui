...
namespace PDS.ViewYourFunding.Web.Areas.LoggedIn.Models
{
    ...
    /// </summary>
    public class LocalAuthorityHistoryViewModel : LoggedInProviderBasePage
    {
        /// <summary>
        ...
        public override IList<BreadCrumbViewModel> BreadCrumbItems
        {
            get
            {
                ...
                items.Add(LocalAuthorityAllocationHistoryBreadcrumb(true, FundingStream.FundingStreamName.ToUIPathComponent(), OrganisationUkprn));
                return items;
            }
        }
