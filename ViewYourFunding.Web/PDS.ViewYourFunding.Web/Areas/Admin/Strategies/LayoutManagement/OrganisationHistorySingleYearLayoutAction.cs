...
{
    /// <summary>
    /// The Organisation History Single Year Layout Action class.
    /// </summary>
    public class OrganisationHistorySingleYearLayoutAction : PreviewLayoutActionBase, IPreviewLayoutAction
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrganisationHistorySingleYearLayoutAction"/> class.
        /// </summary>
        /// <param name="adminSettingsService">The admin settings service.</param>
        public OrganisationHistorySingleYearLayoutAction(IAdminSettingsService adminSettingsService)
        ...
        /// <inheritdoc />
        public FundingViewScope FundingViewScope => FundingViewScope.OrganisationHistorySingleYear;
            ...
            PreviewLayoutViewModel previewLayoutModel)
        {
            ...
            return (ViewYourFundingConstants.RouteName_LocalAuthorityHistorySingleYear, routeValues);
        }
    }
}