...
{
    /// <summary>
    /// The Provider History layout Action class.
    /// </summary>
    public class ProviderHistoryLayoutAction : PreviewLayoutActionBase, IPreviewLayoutAction
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProviderHistoryLayoutAction"/> class.
        /// </summary>
        /// <param name="adminSettingsService">The admin settings service.</param>
        public ProviderHistoryLayoutAction(IAdminSettingsService adminSettingsService)
            : base(
        ...
        /// <inheritdoc />
        public FundingViewScope FundingViewScope => FundingViewScope.ProviderHistory;
            ...
            PreviewLayoutViewModel previewLayoutModel)
        {
            ...
            return (ViewYourFundingConstants.RouteName_ProviderHistory, routeValues);
        }
    }
}