...
{
    /// <summary>
    /// Class for the Next Payment pages' view models.
    /// </summary>
    public class NextPaymentPageViewModel : AdminPageBaseViewModel
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets the breadcrumb for the next payment list page.
        /// </summary>
        /// <param name="fundingStreamId">The funding stream ID.</param>
        /// <param name="fundingStreamName">The funding stream name.</param>
        /// <param name="isCurrentPage">A bool indicating whether or not this is the current page.</param>
        /// <returns>The breadcrumb for the next payment list page.</returns>
        protected BreadCrumbViewModel NextPaymentsBreadCrumb(
            int fundingStreamId,
            string fundingStreamName,
            bool isCurrentPage = false) =>
                new BreadCrumbViewModel
                {
                    ...
                    Link = new MvcRouteLinkViewModel
                    {
                        LinkText = $"{fundingStreamName} Next Payments",
                        RouteName = ViewYourFundingConstants.RouteName_AdminNextPaymentIndex,
                        Parameters = new { FundingStreamId = fundingStreamId }
                    }
                };

        /// <summary>
        /// Gets the breadcrumb for next payment action page.
        /// </summary>
        /// <param name="nextPaymentId">The next payment type identifier.</param>
        /// <param name="fundingStreamId">The funding stream ID.</param>
        /// <param name="actionMode">The action mode.</param>
        /// <param name="isCurrentPage">A bool indicating whether or not this is the current page.</param>
        /// <returns>The breadcrumb for next payment action page.</returns>
        protected BreadCrumbViewModel NextPaymentActionModeBreadCrumb(
            int? nextPaymentId,
            int fundingStreamId,
            ...
            bool isCurrentPage = false) =>
                new BreadCrumbViewModel
                {
                    ...
                    Link = new MvcRouteLinkViewModel
                    {
                        LinkText = $"{actionMode} Next Payment",
                        RouteName = ViewYourFundingConstants.RouteName_AdminNextPaymentAction,
                        Parameters = new { nextPaymentId = nextPaymentId, FundingStreamId = fundingStreamId, actionMode = actionMode }
                    }
                };

        /// <summary>
        /// Gets the breadcrumb for next payment are you sure page.
        /// </summary>
        /// <param name="isCurrentPage">A bool indicating whether or not this is the current page.</param>
        /// <returns>The breadcrumb next payment are you sure page.</returns>
        protected BreadCrumbViewModel NextPaymentAreYouSureBreadCrumb(bool isCurrentPage = false) =>
                new BreadCrumbViewModel
                {
                    IsCurrentPage = isCurrentPage,
                    Link = new MvcRouteLinkViewModel
