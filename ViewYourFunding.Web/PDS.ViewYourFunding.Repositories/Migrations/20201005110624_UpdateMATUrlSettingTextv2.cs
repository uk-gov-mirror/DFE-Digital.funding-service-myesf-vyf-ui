...
{
    /// <summary>
    /// The UpdateMATUrlSettingText second version.
    /// </summary>
    /// <seealso cref="Migration" />
    public partial class UpdateMATUrlSettingTextv2 : Migration
    {
        /// <inheritdoc/>
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            var assembly = System.Reflection.Assembly.GetAssembly(typeof(Context));
            const string script = "PDS.ViewYourFunding.Repositories.Scripts.UpdateMATUrlSettingText.sql";
        ...
        {
            var assembly = System.Reflection.Assembly.GetAssembly(typeof(Context));
            const string script = "PDS.ViewYourFunding.Repositories.Scripts.UpdateMATUrlSettingText_Rollback.sql";
            var stream = assembly.GetManifestResourceStream(script);
            if (stream != null)
            {
                using var textStreamReader = new System.IO.StreamReader(stream);
