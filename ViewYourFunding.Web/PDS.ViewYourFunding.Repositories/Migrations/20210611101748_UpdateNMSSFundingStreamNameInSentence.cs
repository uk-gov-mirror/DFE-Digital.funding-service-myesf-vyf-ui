...
{
    /// <summary>
    /// Update the NMSS funding stream name in sentence.
    /// </summary>
    public partial class UpdateNMSSFundingStreamNameInSentence : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            const string script = "PDS.ViewYourFunding.Repositories.Scripts.UpdateNMSSNameInSentence.sql";
            ApplyMigrationScript(migrationBuilder, script);
        }

        protected override void Down(MigrationBuilder migrationBuilder)
        {
            const string script = "PDS.ViewYourFunding.Repositories.Scripts.UpdateNMSSNameInSentence_ROLLBACK.sql";
            ApplyMigrationScript(migrationBuilder, script);
        }
