...
namespace PDS.ViewYourFunding.Repositories.Migrations
{
    ...
    /// </summary>
    public partial class UpdateNMSSCsvSettings : Migration
    {
        /// <inheritdoc/>
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            const string script = "PDS.ViewYourFunding.Repositories.Scripts.UpdateNMSSCsvSettings.sql";
        ...
        {
            const string script = "PDS.ViewYourFunding.Repositories.Scripts.UpdateNMSSCsvSettings_ROLLBACK.sql";
            var assembly = System.Reflection.Assembly.GetAssembly(typeof(Context));
            var stream = assembly.GetManifestResourceStream(script);
            if (stream == null)
            {
