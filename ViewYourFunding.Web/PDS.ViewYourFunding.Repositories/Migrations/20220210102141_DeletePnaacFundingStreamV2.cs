...
{
    /// <summary>
    /// Delete the PNAAC funding stream and related items.
    /// </summary>
    public partial class DeletePnaacFundingStreamV2 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            const string script = "PDS.ViewYourFunding.Repositories.Scripts.DeletePnaacSettingsAndPublications.sql";
        ...
        {
            const string script = "PDS.ViewYourFunding.Repositories.Scripts.DeletePnaacSettingsAndPublicationsROLLBACK.sql";
            var assembly = System.Reflection.Assembly.GetAssembly(typeof(Context));
            var stream = assembly.GetManifestResourceStream(script);
            if (stream == null)
            {
