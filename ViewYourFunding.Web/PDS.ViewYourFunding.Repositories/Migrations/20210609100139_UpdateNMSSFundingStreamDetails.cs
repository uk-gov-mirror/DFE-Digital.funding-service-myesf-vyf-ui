...
{
    /// <summary>
    /// Update the NMSS funding stream attributes for Name, ParantProviderType,Name within sentence, RelevantForProvidersLoggedIn .
    /// </summary>
    public partial class UpdateNMSSFundingStreamDetails : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            const string script = "PDS.ViewYourFunding.Repositories.Scripts.UpdateNMSSNameAndOtherAttributes.sql";
            ApplyMigrationScript(migrationBuilder, script);
        }

        protected override void Down(MigrationBuilder migrationBuilder)
        {
            const string script = "PDS.ViewYourFunding.Repositories.Scripts.UpdateNMSSNameAndOtherAttributes_ROLLBACK.sql";
            ApplyMigrationScript(migrationBuilder, script);
        }
