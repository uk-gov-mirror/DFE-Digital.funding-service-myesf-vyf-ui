...
{
    /// <summary>
    /// UpdatePNAShowOnOrganisationLoggedInView Migration.
    /// </summary>
    /// <seealso cref="Migration" />
    public partial class UpdatePNAShowOnOrganisationLoggedInView : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            const string script = "PDS.ViewYourFunding.Repositories.Scripts.UpdatePNAShowOnOrganisationLoggedInView.sql";
            ApplyMigrationScript(migrationBuilder, script);
        }

        protected override void Down(MigrationBuilder migrationBuilder)
        {
            const string script = "PDS.ViewYourFunding.Repositories.Scripts.UpdatePNAShowOnOrganisationLoggedInView_ROLLBACK.sql";
            ApplyMigrationScript(migrationBuilder, script);
        }
