...
{
    public partial class UpdateNMSSHistoryIndependentOfPublications : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            const string script = "PDS.ViewYourFunding.Repositories.Scripts.UpdateNMSSHistoryIndependentOfPublications.sql";
            ApplyMigrationScript(migrationBuilder, script);
        }

        protected override void Down(MigrationBuilder migrationBuilder)
        {
            const string script = "PDS.ViewYourFunding.Repositories.Scripts.UpdateNMSSHistoryIndependentOfPublications_ROLLBACK.sql";
            ApplyMigrationScript(migrationBuilder, script);
        }
