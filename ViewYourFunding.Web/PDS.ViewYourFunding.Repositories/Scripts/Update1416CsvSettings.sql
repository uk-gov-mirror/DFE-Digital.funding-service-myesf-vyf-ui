...
IF NOT EXISTS (SELECT Id FROM FundingStreams WHERE FundingStreamCode = '1416')
BEGIN
    -- Funding stream
...
ELSE
    BEGIN
        INSERT SettingValues (FundingStreamId, SettingId, Value, CreatedAt, LastUpdatedAt, LastUpdatedBy)
        VALUES (@fundingStreamId, @fileSizeSettingId, '24576', @currentDateTime, @currentDateTime, @migrationUser)
    END
