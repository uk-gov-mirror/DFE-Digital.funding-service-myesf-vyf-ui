...
{
    [TestClass]
    public class ExternalApiTests_GAG_Provider_AC_2324 : BaseExternalApiTests
    {
        private const string CurrentClassName = nameof(ExternalApiTests_GAG_Provider_AC_2324);
        private const string LayoutId = "a73237b1-2677-4035-bfd7-265ee55837df";
        private const string Schema = "GAG_SchemaMin0-0Max100-0_TemplateMin0-0Max100-0_LoggedInProvider_AC_2324.json";
