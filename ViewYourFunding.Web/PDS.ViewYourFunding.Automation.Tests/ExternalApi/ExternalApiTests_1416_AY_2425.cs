...
namespace PDS.ViewYourFunding.Automation.Tests.LoggedIn
{
    ...
    public class ExternalApiTests_1416_AY_2425 : BaseExternalApiTests
    {
        private const string CurrentClassName = nameof(ExternalApiTests_1416_AY_2425);
        private const string GeneralLayoutId = "b68a024b-20b3-47c6-a2e9-68f68c42f909";
        private const string GeneralSchema = "1416_SchemaMin0-0Max100-0_TemplateMin0-0Max100-0_LoggedInProvider_AY_2425.json";
        private const string FundingStreamCode = "1416";
        private const string FundingPeriod = "AY-2425";
