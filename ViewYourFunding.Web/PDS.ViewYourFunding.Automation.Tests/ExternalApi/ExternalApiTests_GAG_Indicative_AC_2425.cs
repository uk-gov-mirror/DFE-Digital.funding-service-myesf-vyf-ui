...
{
    [TestClass]
    public class ExternalApiTests_GAG_Indicative_AC_2425 : BaseExternalApiTests
    {
        private const string CurrentClassName = nameof(ExternalApiTests_GAG_Indicative_AC_2425);
        private const string LayoutId = "f3294c7c-85a8-4a81-aef5-94105ea55b49";
        private const string Schema = "GAG_Indicative_SchemaMin0-0Max100-0_TemplateMin0-0Max100-0_LoggedInProvider_AC_2425.json";
