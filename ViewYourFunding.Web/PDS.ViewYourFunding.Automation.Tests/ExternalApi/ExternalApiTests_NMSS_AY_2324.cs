...
{
    [TestClass]
    public class ExternalApiTests_NMSS_AY_2324 : BaseExternalApiTests
    {
        private const string CurrentClassName = nameof(ExternalApiTests_NMSS_AY_2324);
        private const string LayoutId = "9301ae02-1e6d-4732-a140-8eb1f460abbc";
        private const string DefaultFundingPeriodCode = "AY-2324";
        private const string DefaultFundingStreamCode = "NMSS";
        private const string Schema = "NMSS_SchemaMin0-0Max100-0_TemplateMin0-0Max100-0_LoggedInProvider_AY_2324.json";
