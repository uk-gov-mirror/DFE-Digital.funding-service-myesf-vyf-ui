...
{
    [TestClass]
    public class ExternalApiTests_GAG_Indicative_AC_2223 : BaseExternalApiTests
    {
        private const string CurrentClassName = nameof(ExternalApiTests_GAG_Indicative_AC_2223);
        private const string LayoutId = "ad92d448-5990-400d-8ef6-a36b53d16207";
        private const string Schema = "GAG_Indicative_SchemaMin0-0Max100-0_TemplateMin0-0Max100-0_LoggedInProvider_AC_2223.json";
