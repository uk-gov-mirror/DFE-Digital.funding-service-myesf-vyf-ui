...
namespace PDS.ViewYourFunding.Automation.Tests.LoggedIn
{
    ...
    public class ExternalApiTests_PNA_AC_2425 : BaseExternalApiTests
    {
        private const string CurrentClassName = nameof(ExternalApiTests_PNA_AC_2425);
        private const string LayoutId = "6406b0eb-451f-4429-b015-24c3de669325";
        private const string Schema = "PNA_SchemaMin0-0Max100-0_TemplateMin0-0Max100-0_LoggedInProvider_AC_2425.json";
        private const string FundingStreamCode = "PNA";
        private const string FundingPeriod = "AC-2425";
        ...
        [DataRow("html_pna_free_schools", "PNA-AC-2223-10072811-1_0")]
        [TestMethod]
        public async Task FreeSchools_ExternalApi_RenderHtml(string expectedHtmlFileName, string providerFundingId)
        {
            // Arrange
            var strExpectedHtml = await GetExpectedHtmlAsync(CurrentClassName, expectedHtmlFileName);
