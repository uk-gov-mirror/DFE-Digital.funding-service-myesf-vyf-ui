...
{
    [TestClass]
    public class ExternalApiTests_GAG_Indicative_AC_2526 : BaseExternalApiTests
    {
        private const string CurrentClassName = nameof(ExternalApiTests_GAG_Indicative_AC_2526);
        private const string LayoutId = "d1adb61f-c418-4df2-850b-ab6d1acd44d3";
        private const string Schema = "GAG_Indicative_SchemaMin0-0Max100-0_TemplateMin0-0Max100-0_LoggedInProvider_AC_2526.json";
