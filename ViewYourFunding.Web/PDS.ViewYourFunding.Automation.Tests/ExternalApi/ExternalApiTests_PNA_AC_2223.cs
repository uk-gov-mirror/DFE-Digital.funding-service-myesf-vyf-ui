...
namespace PDS.ViewYourFunding.Automation.Tests.LoggedIn
{
    ...
    public class ExternalApiTests_PNA_AC_2223 : BaseExternalApiTests
    {
        private const string CurrentClassName = nameof(ExternalApiTests_PNA_AC_2223);
        ...
        private const string FundingPeriod = "AC-2223";
