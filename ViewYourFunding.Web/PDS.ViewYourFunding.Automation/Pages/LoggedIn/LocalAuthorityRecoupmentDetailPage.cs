...
{
    public class LocalAuthorityRecoupmentDetailPage : ViewYourFundingBasePage
    {
        #region Actions

        public static void NavigateToLaRecoupmentPageViaLogin(string username, string password)
        {
            ProviderPage.NavigateToRecoupmentPageViaLogin(username, password);
            LocalAuthorityRecoupmentSummaryPage.ExpandAccordion();
            LocalAuthorityRecoupmentSummaryPage.ClickRecoupmentCalculationsLink();
        }

        public static void ClickOnSplitYearsTab()
        {
            AnomaliesTabLink.MoveAndClick();
        }
        ...
        {
            AnomaliesTabLink.Should().NotBeNull();
        }
        ...
        public static IWebElement RecoupmentCalculationsTabContent => TabsSection.FindElement(By.Id("recoupment-calculations"));

        public static IWebElement AnomaliesTabContent => TabsSection.FindElement(By.Id("anomalies"));

        public static IWebElement PhaseTotalsTabContent => TabsSection.FindElement(By.Id("phase-totals"));
        ...
        protected static IWebElement AnomaliesTabLink => TabsSection.FindElement(By.LinkText("Anomalies"));
